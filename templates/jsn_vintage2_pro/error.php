                        ...
                        <div class="table-cell">
                            ...
                            <div class="content-inner">
                                <div class="box-image-left">
                                    <img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/404-error.png" />
                                </div>
                                <div class="box-content-right">
                                    <!-- <h4 class="jsn-error-text">Oops ! <?php echo htmlspecialchars($this->error->getMessage(), ENT_QUOTES, 'UTF-8');?> at this location</h4> -->
                                    <p class="jsn-error-text-desc">Sorry, the page not found</p>
                                    <div class="goto-home"><a href="<?php echo JUri::base();?>">Take Me Home</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
