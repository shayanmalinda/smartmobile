		...
		<div class="catItemHeader">
		  ...
		  <?php endif; ?>
			...
			<span class="catItemAuthor">
				...
				<a rel="author" href="<?php echo $this->item->author->link; ?>"><i class="fa fa-user-o"></i><?php echo $this->item->author->name; ?></a>
				<?php else: ?>
			...
			<span class="catItemDateCreated">
				<i class="fa fa-calendar-o"></i><?php echo JHTML::_('date', $this->item->created , JText::_('F d Y')); ?>
			</span>
			<?php endif; ?>
