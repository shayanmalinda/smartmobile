	...
	protected function getComponentBody()
	{
		...
		$data = array(
				...
				array(
					...
					'items' => array(
						...
						array(
							...
							'render' => array(
								'name' => 'PaneComingSoon',
								'file' => "{$root}/plugins/system/sunfw/assets/joomlashine/admin/js/coming-soon/render.js?{$vd}",
			...
			'textMapping' => array(
				...
				'pane-coming-soon-cmZjnUuu' => JText::_('SUNFW_PANE_COMING_SOON_LIMITATION_MORE_INFO'),
